...
**Explicitly not claimed here:** no functional/behavioral testing of staging beyond the narrow STAGING-002 trigger-path test above has been performed, and Checkpoint 4 Part A's dashboard-verified settings have not been exercised by any live signup/invite/password-reset call. Checkpoint 4 overall is partially complete (Part A only); Part B (URL-dependent) remains not started. STAGING-001 was not touched.
